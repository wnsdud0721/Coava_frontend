...
let coavameme: [coavaMeme] = [
    ...
    coavaMeme(coavaMemeImg: UIImage(named: "중요한 건 꺾이지 않는 마음")!, coavaMemeTitle: "중요한 건 꺾이지 않는 마음", coavaMemeExplain: "DRX 소속 프로게이며 김혁규(Deft)선수의 인터뷰를 담은 영상의 제목에서 유래. 2022 카타르 월드컵에서 대표팀이 극적으로 16강전에 올라가고 나서 더 크게 유행하는 밈이 되었다.", coavaMemeBackground: UIImage())
]
